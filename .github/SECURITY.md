...
Please consult the [Security Advisories](https://github.com/dorssel/dotnet-aes-extra/security/advisories) for any known
outstanding security vulnerabilities in the latest release.

## Reporting a Vulnerability

Please [report vulnerabilities](https://github.com/dorssel/dotnet-aes-extra/security/advisories/new) privately,
